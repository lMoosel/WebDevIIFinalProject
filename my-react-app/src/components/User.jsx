...
export function User(props) {
  ...
  } = useQuery(queries.GET_USER_STATS, {
    variables: {
      id: user._id,
    },
  });
  ...
  const {
    data: friendStatsData,
    loading: friendStatsLoading,
    error: friendStatsError,
  } = useQuery(queries.GET_USER_STATS, {
    variables: {
      id: userid,
    },
  ...
  if (userLoading || friendLoading || userStatsLoading || friendStatsLoading)
    return <p>Loading...</p>;
  if (userError || friendError || userStatsError || friendStatsError)
    return <p>404 Error : Please try again</p>;
