...
function Callback() {
    ...
    const [authorizeSpotify, { data: spotifyData, loading: spotifyLoading, error: spotifyError }] = useMutation(queries.AUTHORIZE_SPOTIFY);
    const [createUser, { data: userData, loading: userLoading, error: userError }] = useMutation(queries.CREATE_USER);
